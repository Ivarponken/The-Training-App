...
class AuthController extends Controller
{
    ...
    public function refresh(Request $request)
    {
        ...
        //kontrolleraatt angivet token finns i databasen

        $user = $this->repo->getUserbyRefreshToken($refreshToken);
        if (!$user) {
            return response()->json(['error' => 'Invalid refreshtoken (no user)'], 401);
        }
        ...
        $cookie = Cookie::create('refresh_token', $newRefreshtoken, $expiresAt, 'refresh', null, true, true, false, 'lax');
